...
Alternatif state management lain seperti Context API, Zustand, atau Recoil juga layak dipertimbangkan tergantung kompleksitas aplikasi Anda.',
        ...
        $videos = [
            ...
            [
                ...
                'description' => 'Pelajari dasar-dasar Vue.js 3 dalam satu video. Mulai dari installation, directives, reactivity, hingga component lifecycle.',
            ...
            [
                ...
                'description' => 'Bangun backend API yang robust dengan Node.js dan Express. Pelajari routing, middleware, error handling, dan database connection.',
            ...
            [
                ...
                'description' => 'Membangun aplikasi mobile cross-platform dengan Flutter dan Dart. Pelajari widget system, state management, dan layouting.',
            ...
            [
                ...
                'description' => 'Pengenalan Python untuk web development menggunakan Django dan Flask. Pelajari syntax dasar Python dan struktur framework web.',
            ...
            [
                ...
                'description' => 'Pelajari layanan dasar AWS seperti EC2, S3, RDS, dan Lambda. Video ini memberikan overview yang solid tentang cloud computing.',
