        ...
        <div class="bg-white py-6 px-6 shadow rounded-lg">
            <div class="flex items-center space-x-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Membership Type {{ $user->membership_type }}</p>
                </div>
            </div>
        </div>
        
        <form class="mt-8 space-y-6" action="{{ route('login.password') }}" method="POST">
            @csrf
